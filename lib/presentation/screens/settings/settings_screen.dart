...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> loadCustomers() async {
    ...
    final customerSelectedJson =
        await SharedPreferencesService.getSharedPreference(
            SharedPreferencesService.customerSelectedJson);
    setState(() {
  ...
  Future<void> loadTechnologies() async {
    final peopleValue =
        await SharedPreferencesService.getSharedPreferenceBool(
            SharedPreferencesService.peopleSelected);
  ...
  Future<void> saveConfig() async {
    ...
    final tokenMobile = await SharedPreferencesService.getSharedPreference(
        SharedPreferencesService.tokenMobile);

    if (selectedCustomer == null) {
      snackbarMessage(context,
          AppLocalizations.of(context)!.select_client,
      ...
      snackbarMessage(context,
          AppLocalizations.of(context)!.select_store,
          AppTheme.secondaryColor,
          10);
      isSavingConfig = false;
      await Future.delayed(const Duration(seconds: 2));
      return;
    } else if (!isCheckedPeople && !isCheckedRFID && !isCheckedRF) {
      snackbarMessage(context,
          AppLocalizations.of(context)!.select_technology,
          AppTheme.secondaryColor,
          10);
      isSavingConfig = false;
      await Future.delayed(const Duration(seconds: 2));
      ...
      valuesToSave.add({
        SharedPreferencesService.customerSelected:
            selectedCustomer?.description
      });
      valuesToSave.add({
        SharedPreferencesService.customerCodeSelected:
      ...
      Fluttertoast.showToast(
          msg: AppLocalizations.of(context)!.config_saved);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isSavingConfig
          ...
          : isLoadingInfo
              ? CustomLoaderScreen(
                  message: AppLocalizations.of(context)!.loading_customers_info)
                        ...
                        child: Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                TitleText(
                                    textShow: AppLocalizations.of(context)!.customer,
                                ...
                                isLoadingCustomers
                                    ...
                                    : DropdownSearch<CustomerResponseEntity>(
                                        ...
                                        itemAsString: (CustomerResponseEntity c) =>
                                            '${c.accountCode} - ${c.description}',
                                        selectedItem: selectedCustomer,
                                        compareFn: (a, b) =>
                                            a.customerToken == b.customerToken,
                                        onChanged: (customer) {
                                          if (customer != null) {
                                            setState(() {
                                              selectedCustomer = customer;
                                ...
                                SizedBox(
                                  ...
                                  child: DropdownButton<String>(
                                    ...
                                    underline: Container(
                                        height: 1, color: AppTheme.primaryColor),
                                ...
                                GridView.count(
                                  ...
                                  children: [
                                    TechCheckbox(
                                      label: AppLocalizations.of(context)!.pc,
                                      value: isCheckedPeople,
