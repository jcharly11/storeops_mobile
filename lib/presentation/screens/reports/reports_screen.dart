...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Future<List<EventsFirebaseModel>> _getReportsInfo() async {
    ...
    final audibleAlarms = eventsFiltered.where((e) => e.silent == false).toList();
    ...
    return Scaffold(
      ...
      body: Center(
        child: isLoadingEvents
            ? CustomLoaderScreen(message: AppLocalizations.of(context)!.daily_report)
            : Column(
                children: [
                  Expanded(
                      flex: 1,
                      child: Row(
                        ...
                        children: [
                          ...
                          CustomButtonFilter(icon: Icons.directions_walk, text: AppLocalizations.of(context)!.pc, active: false),
                        ],
                      )),
                  Divider(),
                  Expanded(
                            ...
                            children: [
                              Expanded(
                                  ...
                                  child: Column(children: [
                                    ...
                                    Text('$storeId - $storeName', textAlign: TextAlign.center),
                                  ])),
                              Expanded(
                                  flex: 5,
                                  child: Column(children: [
                                  ...
                                  child: Padding(
                                      ...
                                      child: Center(
                                          child: Column(
                                            ...
                                            Expanded(
                                              flex: 4,
                                              child: Text(AppLocalizations.of(context)!.avg_daily_audible_alarms,
                                                  textAlign: TextAlign.center,
                                                  style: TextStyle(
                                                      fontSize: 12,
                                                      fontWeight: FontWeight.w500,
