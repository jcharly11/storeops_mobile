...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _getInfoClient() async {
    final client = await SharedPreferencesService.getSharedPreference(
    ...
    final storeNumb = await SharedPreferencesService.getSharedPreference(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: CustomFabButton(
        onPressed: navigateConfig,
        icon: Icons.settings_outlined,
      ),
      floatingActionButtonLocation: FloatingActionButtonLocation.endDocked,
      drawer:
          SideMenu(scaffoldKey: scaffoldKey, onReturnFromSettings: _getInfoClient),
      body: Center(
        child: Column(
          children: [
            Expanded(
                  ...
                  child: Column(
                    children: [
                      isCheckingClient
                          ...
                          : clientSelected == null
                              ? Text(
                                  AppLocalizations.of(context)!.waitingClientSelection,
                                  style: TextStyle(
                                    color: Colors.red,
                                    fontSize: 20,
