...
class _EventsScreenState extends State<EventsScreen> {
  ...
  Future<void> _getCustomerInfo() async {
    ...
    final accountCode = await SharedPreferencesService.getSharedPreference(
        SharedPreferencesService.customerCodeSelected);
    final store = await SharedPreferencesService.getSharedPreference(
        SharedPreferencesService.storeIdSelected);
    final storeN = await SharedPreferencesService.getSharedPreference(
        SharedPreferencesService.storeSelected);
  ...
  Future<List<EventsFirebaseModel>> loadEvents(
      String filter, DateTime? startDate, DateTime? endDate) async {
    setState(() => isLoadingEvents = true);
                          ...
                          child: Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final event =
                                    EventsFirebaseModel.fromMap(data);
...
//       String filter, Timestamp? startDate, Timestamp? endDate) async {
//     setState(() => isLoadingEvents = true);
...
//                               if (value != null) {
//                                 final Timestamp startDate = Timestamp.fromDate(value.start);
//                                 final Timestamp endDate = Timestamp.fromDate(value.end);
...
//                     child: Container(color: AppTheme.buttonsColor),
//                   ),
//                 ),
//                 Expanded(
//                   flex: 9,
